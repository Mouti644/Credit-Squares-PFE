...
namespace advans_backend.Migrations
{
    ...
    [Migration("20240512200132_RemoveAgenceEntreprise")]
    partial class RemoveAgenceEntreprise
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("advans_backend.Models.Analyse", b =>
                {
                    ...
                    b.Property<string>("MontantProposé")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("advans_backend.Models.InteractiviteDecideur", b =>
                {
                    ...
                    b.HasIndex("ComiteIdComite");

                    b.ToTable("InteractiviteDecideur");
                });
            ...
            modelBuilder.Entity("advans_backend.Models.InteractiviteDecideur", b =>
                {
                    b.HasOne("advans_backend.Models.Comite", null)
                        .WithMany("InteractiviteDecideurs")
                        .HasForeignKey("ComiteIdComite");
                });
            ...
            modelBuilder.Entity("advans_backend.Models.Comite", b =>
                {
                    b.Navigation("InteractiviteDecideurs");
                });
